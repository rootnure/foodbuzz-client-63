...
const Blog = () => {
    return (
        <section className="my-12">
            <h2 className="text-3xl text-center my-16">Blog</h2>
            <div className="grid grid-cols-3 gap-4">
                <div className="card card-compact bg-base-100 shadow-xl">
                    ...
                    <div className="card-body">
                        <h2 className="card-title">What is One way data binding?</h2>
                ...
                <div className="card card-compact bg-base-100 shadow-xl">
                    ...
                    <div className="card-body">
                        <h2 className="card-title">What is NPM in node.js?</h2>
                ...
                <div className="card card-compact bg-base-100 shadow-xl">
                    ...
                    <div className="card-body">
                        <h2 className="card-title">Different between Mongodb database vs mySQL database.</h2>
                        <table>
                            <thead>
                                <tr>
                                    <th></th>
